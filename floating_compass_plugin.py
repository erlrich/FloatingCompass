...
# floating_compass_plugin.py
import os
from qgis.PyQt.QtWidgets import QAction
from qgis.PyQt.QtGui import QIcon

from .floating_compass_tool import FloatingCompassMapTool
from .floating_compass_about_dialog import FloatingCompassAboutDialog


class FloatingCompassPlugin:
    ...
    def initGui(self):
        ...
        icon_path = os.path.join(plugin_dir, "icon", "compass.svg")
        ...
        self.iface.addPluginToMenu("Floating Compass", self.action)
        ...
        self.action_about = QAction(
            ...
            "About Floating Compass",
            self.iface.mainWindow()
        )
        self.action_about.triggered.connect(self.show_about_dialog)

        self.iface.addPluginToMenu("Floating Compass", self.action_about)


        # =========================
        # CREATE TOOL ONCE (SINGLETON)
        # =========================
        self.tool = FloatingCompassMapTool(self.iface)
    ...
    def show_about_dialog(self):
        dlg = FloatingCompassAboutDialog(self.iface.mainWindow())
        dlg.exec_()
    ...
    def unload(self):
        ...
        if self.action:
            try:
                ...
                self.iface.removePluginMenu("Floating Compass", self.action)
            except Exception:
                pass
            self.action = None
        ...
        if hasattr(self, "action_about") and self.action_about:
            try:
                self.iface.removePluginMenu("Floating Compass", self.action_about)
            except Exception:
                pass
    ...
    def show_first_run_message(self):
        ...
        s = QSettings()
        key = "FloatingCompass/first_run_done"
        ...
        QMessageBox.information(
            self.iface.mainWindow(),
            "Floating Compass",
            "Floating Compass by Achmad Amrulloh\n\n"
